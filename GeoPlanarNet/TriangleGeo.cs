...
namespace GeoPlanarNet
{
    public static class TriangleGeo
    {
        ...
        public static double Square(PointF apex1, PointF apex2, PointF apex3)
        {
            return Square(apex1.X, apex1.Y, apex2.X, apex2.Y, apex3.X, apex3.Y);
        }
        ...
        /// <param name="apex3"> Apex 3 </param>
        /// <returns> Triangle square </returns>
        public static double Square(Point apex1, Point apex2, Point apex3)
        {
            return Square(apex1.X, apex1.Y, apex2.X, apex2.Y, apex3.X, apex3.Y);
        }
        ...
        /// <returns> Triangle square </returns>
        public static double Square(double apex1X, double apex1Y, double apex2X, double apex2Y, double apex3X, double apex3Y)
        {
